    ...
    <div class="container py-5 px-5">
        ...
        <form action="{{ route('admin.projects.update', $project) }}" method="Post">
            ...
            <div class="mb-3 ">
                ...
                <input type="text" class="form-control border border-black opacity-75" id="project-title" name="title"
                    value="{{ old('title', $project->title) }}">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Modifica descrizione</label>
                <textarea class="form-control border border-black opacity-75" id="project-description" name="description"
