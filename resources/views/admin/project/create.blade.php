    ...
    <div class="container py-5 px-5">
        ...
        <form action="{{ route('admin.projects.store') }}" method="Post">
            ...
            <div class="mb-3 ">
                ...
                <input type="text" class="form-control border border-black opacity-50" id="project-title" name="title">
            </div>
            <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label">Inserisci descrizione</label>
                <textarea class="form-control border border-black opacity-50" id="project-description" name="description" rows="3"></textarea>
            </div>
            <div class="mb-3 col-5">
                <label for="formFileMultiple" class="form-label">Inserisci immagine</label>
                <input class="form-control" type="file" id="project-image" name="image" multiple>
            </div>
